      ...
      <div className="hero__inner">
        ...
        <div className="hero__content">
          ...
          <p className="hero__sub">
            ...
            get peer help, and share academic resources — all in one unified platform.
          </p>

          <div className="hero__actions">
            <Link
              to="/register"
              className="btn btn--primary btn--lg hero__cta-main"
            >
        ...
        <div className="hero__visual">
          ...
          <div className="hero__chip hero__chip--4">
            <div className="hero__chip-icon" style={{background:'#FFF7ED'}}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#F59E0B" strokeWidth="2.2" strokeLinecap="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>
            </div>
            <div>
              <div className="hero__chip-title">Resource Shared</div>
              <div className="hero__chip-sub">DSA Notes PDF · just now</div>
            </div>
          </div>
